...
import 'package:quiz/quizBib/resultados.dart';
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: Scaffold(
        ...
        appBar: AppBar(
          backgroundColor: const Color.fromARGB(255, 233, 208, 116),
          title: Row(
                    ...
                    return Padding(
                      ...
                      child: SizedBox(
                        ...
                        child: ElevatedButton(
                          ...
                          child: Text(
                            quiz[perguntaNumero - 1]['respostas'][index],
                            style: TextStyle(
