...
import 'dados_quizgeo.dart';

class QuizGeo extends StatefulWidget {
  @override
  QuizState createState() => QuizState();
}

class QuizState extends State<QuizGeo> {
  ...
  void respondeu(int respostaNumero) {
    if (!isRespondido) {
      setState(() {
        ...
        if (quizGeo[perguntaNumero - 1]['alternativa_correta'] ==
            respostaNumero) {
          print("acertou");
          acertos++;
        } else {
      ...
      Future.delayed(Duration(seconds: 1), () {
        setState(() {
          ...
          if (perguntaNumero == 10) {
            Navigator.pushNamed(context, 'ResultadoGeo',
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: Scaffold(
        ...
        appBar: AppBar(
          backgroundColor: const Color.fromARGB(255, 223, 101, 44),
          title: Row(
                    ...
                    child: SizedBox(
                      ...
                      child: Center(
                        child: Text(
                          ...
                          quizGeo[perguntaNumero - 1]['pergunta'],
                          style: TextStyle(
                              fontSize: 25,
                    ...
                    return Padding(
                      ...
                      child: SizedBox(
                        ...
                        child: ElevatedButton(
                          ...
                          child: Text(
                            quizGeo[perguntaNumero - 1]['respostas'][index],
                            style: TextStyle(
