...
import 'dados_quizhis.dart';

class QuizHis extends StatefulWidget {
  @override
  QuizState createState() => QuizState();
}

class QuizState extends State<QuizHis> {
  ...
  void respondeu(int respostaNumero) {
    if (!isRespondido) {
      setState(() {
        ...
        if (quizHis[perguntaNumero - 1]['alternativa_correta'] ==
            respostaNumero) {
          print("acertou");
          acertos++;
        } else {
      ...
      Future.delayed(Duration(seconds: 1), () {
        setState(() {
          ...
          if (perguntaNumero == 10) {
            Navigator.pushNamed(context, 'ResultadoHis',
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: Scaffold(
        ...
        appBar: AppBar(
          backgroundColor: const Color.fromARGB(255, 148, 94, 32),
          title: Row(
                    ...
                    child: SizedBox(
                      ...
                      child: Center(
                        child: Text(
                          ...
                          quizHis[perguntaNumero - 1]['pergunta'],
                          style: TextStyle(
                              fontSize: 25,
                    ...
                    return Padding(
                      ...
                      child: SizedBox(
                        ...
                        child: ElevatedButton(
                          ...
                          child: Text(
                            quizHis[perguntaNumero - 1]['respostas'][index],
                            style: TextStyle(
