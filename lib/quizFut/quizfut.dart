...
import 'dados_quizfut.dart';

class QuizFut extends StatefulWidget {
  @override
  QuizState createState() => QuizState();
}

class QuizState extends State<QuizFut> {
  ...
  void respondeu(int respostaNumero) {
    if (!isRespondido) {
      setState(() {
        ...
        if (quizFut[perguntaNumero - 1]['alternativa_correta'] ==
            respostaNumero) {
          print("acertou");
          acertos++;
        } else {
      ...
      Future.delayed(Duration(seconds: 1), () {
        setState(() {
          ...
          if (perguntaNumero == 10) {
            Navigator.pushNamed(context, 'ResultadoFut',
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: Scaffold(
        ...
        appBar: AppBar(
          backgroundColor: const Color.fromARGB(255, 38, 180, 57),
          title: Row(
                    ...
                    child: SizedBox(
                      ...
                      child: Center(
                        child: Text(
                          ...
                          quizFut[perguntaNumero - 1]['pergunta'],
                          style: TextStyle(
                              fontSize: 25,
                    ...
                    return Padding(
                      ...
                      child: SizedBox(
                        ...
                        child: ElevatedButton(
                          ...
                          child: Text(
                            quizFut[perguntaNumero - 1]['respostas'][index],
                            style: TextStyle(
